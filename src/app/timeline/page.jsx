  ...
  return (
    <div className="w-full p-10 px-40 flex flex-col items-start bg-[#C8C8BE] h-[100vh] py-40">
        <div className='flex my-5 items-center'>
            <Image src={img2} width={200} objectFit='cover' className='w-32 mx-20 h-32 rounded-full'/>
        ...
        <div className='flex my-5 items-center'>
            <Image src={img1} width={200} objectFit='cover' className='w-32 mx-20 h-32 rounded-full'/>
            <div className='flex  flex-col'>
